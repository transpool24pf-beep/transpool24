...
export const whyPageEn: WhyPagePayload = {
  ...
  tips: [
    ...
    },
    {
      ...
      detail:
        "A named contact at the gate or goods-in avoids long waits and trips to the wrong entrance.",
    },
    {
    ...
    },
    {
      ...
      detail:
        "Same-day is not always free. A half-day or full-day slot improves driver matching.",
    },
    {
  ...
  serviceTypes: [
    ...
    },
    {
      ...
      body: "Baden-Württemberg is the home of Mercedes, Porsche and a tight mesh of workshops and parts stockists.\n\nWho we work with: large dealerships (Autohäuser), parts wholesalers and suppliers.\n\nWhat we move: engines, gearboxes or urgent parts while a customer’s car is in the workshop.\n\nThe upside: demand is frequent and ongoing; pricing for professional execution is solid.",
    },
    {
  ...
  howSteps: [
    ...
    },
    {
      ...
      body: "A professional is scheduled for your window with the right vehicle.",
    },
    {
      title: "Transport & handover",
      body: "Your shipment is moved and handed over; you stay informed.",
    },
  ],
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "We are based in Pforzheim and the region and organise runs across Baden-Württemberg and Germany. The booking form checks feasibility for your addresses.",
    },
    {
    ...
    {
      q: "Refrigerated food?",
      a: "For food we emphasise dry carton goods without cold chain. For chilled/frozen, clarify requirements with support before booking.",
    },
    {
    ...
    },
    {
      ...
      a: "Professional drivers and partners. Assignment follows vehicle need and booked service level.",
    },
    {
      q: "Can I cancel or change?",
      a: "Contact us as soon as possible. Options depend on timing and whether a driver is already assigned.",
    },
    {
      q: "How do I reach support?",
      a: "Via the contact and support routes on the website. For active bookings: confirmation and order details.",
    },
    {
      q: "Is payment secure?",
      a: "Online payment via established providers. Confirmation after successful payment.",
    },
    {
