...
export const whyPageFr: WhyPagePayload = {
  ...
  tips: [
    ...
    },
    {
      ...
      detail:
        "Un interlocuteur à la porte ou à la réception évite longues attentes et mauvaise entrée.",
    },
    {
    ...
    },
    {
      ...
      detail:
        "Le jour même n’est pas toujours possible. Une demi-journée ou une journée améliore l’appariement chauffeur.",
    },
    {
  ...
  serviceTypes: [
    ...
    },
    {
      ...
      body: "Le Bade-Württemberg est le berceau de Mercedes, Porsche et d’un réseau dense d’ateliers et de stocks.\n\nAvec qui : grandes concessions (Autohäuser), grossistes en pièces.\n\nCe que nous transportons : moteurs, boîtes de vitesses ou pièces urgentes pendant que la voiture du client est à l’atelier.\n\nL’avantage : demande fréquente et continue ; rémunération solide pour une exécution pro.",
    },
    {
  ...
  howVideoUrl: "",
  howTitle: "Comment fonctionne TransPool24",
  howSteps: [
    {
    ...
    },
    {
      ...
      body: "Un professionnel est planifié sur votre créneau avec le bon véhicule.",
    },
    {
      title: "Transport et remise",
      body: "L’envoi est transporté et remis ; vous restez informé.",
    },
  ],
  howCta: "Réserver un transport",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Nous sommes ancrés à Pforzheim et organisons des tournées en Bade-Wurtemberg et en Allemagne. Le formulaire vérifie la faisabilité pour vos adresses.",
    },
    {
      q: "Quels véhicules ?",
    ...
    {
      q: "Frais réfrigérés ?",
      a: "Pour l’alimentaire nous insistons sur le sec en carton sans froid. Pour le frais, clarifiez avec le support avant réservation.",
    },
    {
    ...
    },
    {
      ...
      a: "Chauffeurs professionnels et partenaires. Affectation selon besoin véhicule et niveau réservé.",
    },
    {
      q: "Annulation ou modification ?",
      a: "Contactez-nous au plus vite. Cela dépend du délai et d’un éventuel chauffeur déjà affecté.",
    },
    {
      q: "Comment joindre le support ?",
      a: "Via les canaux contact/support du site. Pour réservations actives : confirmation et détails commande.",
    },
    {
      q: "Paiement sécurisé ?",
      a: "Paiement en ligne via prestataires établis. Confirmation après paiement réussi.",
    },
    {
