...
export const whyPageTr: WhyPagePayload = {
  ...
  tips: [
    ...
    },
    {
      ...
      detail:
        "Kapı veya mal kabulde doğrudan muhatap uzun beklemeleri ve yanlış girişleri önler.",
    },
    {
    ...
    },
    {
      ...
      detail:
        "Aynı gün her zaman mümkün değil. Yarım gün veya tam gün aralığı sürücü eşleşmesini iyileştirir.",
    },
    {
  ...
  serviceTypes: [
    ...
    },
    {
      ...
      body: "Baden-Württemberg Mercedes, Porsche ve yoğun servis ve parça stoğu ağının merkezidir.\n\nKiminle: büyük bayiler (Autohäuser), yedek parça toptancıları.\n\nNe taşırız: motorlar, şanzımanlar veya araç serviste olan müşteri için acil parçalar.\n\nAvantaj: Talep sık ve süreklidir; profesyonel icra için ücretlendirme sağlamdır.",
    },
    {
  ...
  completingP3:
    "Teslimattan sonra geri bildiriminiz kaliteyi korur ve diğer B2B müşterilere yardım eder.",
  closingLine: "Bir sonraki ticari taşımanızı sabırsızlıkla bekliyoruz.",
  heroImageUrl: "/transpool24-email-banner.png",
  sceneImageUrl: "/images/445.png",
  howVideoUrl: "",
  howTitle: "TransPool24 nasıl çalışır",
  howSteps: [
    {
    ...
    },
    {
      ...
      body: "Pencereniz için uygun araçla profesyonel planlanır.",
    },
    {
      title: "Taşıma ve teslim",
      body: "Gönderiniz taşınır ve teslim edilir; bilgilendirilirsiniz.",
    },
  ],
  howCta: "Şimdi taşıma rezerve edin",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Pforzheim ve bölgede köklüyüz; Baden-Württemberg ve Almanya genelinde sefer düzenleriz. Rezervasyon formu adresleriniz için uygunluğu kontrol eder.",
    },
    {
      q: "Hangi araçlar var?",
    ...
    },
    {
      ...
      a: "Gıdada soğuk zincirsiz kuru koli vurguluyoruz. Soğuk/taşınmış için rezervasyondan önce destekle netleştirin.",
    },
    {
    ...
    },
    {
      ...
      a: "Profesyonel sürücüler ve ortaklar. Atama araç ihtiyacına ve rezerve edilen seviyeye göre.",
    },
    {
      q: "İptal veya değişiklik?",
      a: "En kısa sürede iletişime geçin. Mümkünlük zamanlamaya ve sürücü atanmış olup olmamasına bağlı.",
    },
    {
      q: "Desteğe nasıl ulaşırım?",
      a: "Sitedeki iletişim ve destek yolları üzerinden. Aktif rezervasyonlar için onay ve sipariş detayları.",
    },
    {
      q: "Ödeme güvenli mi?",
      a: "Çevrimiçi ödeme yerleşik sağlayıcılarla. Başarılı ödeme sonrası onay.",
    },
    {
