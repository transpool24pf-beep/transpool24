...
export const whyPageEs: WhyPagePayload = {
  ...
  tips: [
    ...
    },
    {
      ...
      detail:
        "Un interlocutor en puerta o recepción evita largas esperas y entradas equivocadas.",
    },
    {
    ...
    },
    {
      ...
      detail:
        "El mismo día no siempre es posible. Medio día o día completo mejora el emparejamiento de conductor.",
    },
    {
  ...
  serviceTypes: [
    ...
    },
    {
      ...
      body: "Baden-Wurtemberg es el hogar de Mercedes, Porsche y una malla densa de talleres y stocks.\n\nCon quién: grandes concesionarios (Autohäuser), mayoristas de piezas.\n\nQué movemos: motores, cajas de cambios o piezas urgentes mientras el coche del cliente está en el taller.\n\nVentaja: demanda frecuente y continua; la retribución por ejecución profesional es sólida.",
    },
    {
  ...
  howVideoUrl: "",
  howTitle: "Cómo funciona TransPool24",
  howSteps: [
    {
    ...
    },
    {
      ...
      body: "Se programa un profesional en su ventana con el vehículo adecuado.",
    },
    {
      title: "Transporte y entrega",
      body: "Su envío se transporta y entrega; usted permanece informado.",
    },
  ],
  howCta: "Reservar transporte ahora",
  ...
  faqs: [
    ...
    {
      q: "¿Cubren mi zona?",
      a: "Estamos arraigados en Pforzheim y la región y organizamos rutas en Baden-Wurtemberg y Alemania. El formulario comprueba viabilidad para sus direcciones.",
    },
    {
      q: "¿Qué vehículos hay?",
    ...
    },
    {
      ...
      a: "Para alimentos enfatizamos seco en cartón sin frío. Para refrigerado aclare con soporte antes de reservar.",
    },
    {
    ...
    },
    {
      ...
      a: "Conductores profesionales y socios. Asignación según necesidad de vehículo y nivel reservado.",
    },
    {
      q: "¿Cancelar o cambiar?",
      a: "Contacte cuanto antes. Depende del momento y si ya hay conductor asignado.",
    },
    {
      q: "¿Cómo contacto soporte?",
      a: "Vía contacto y soporte en la web. Para reservas activas: confirmación y detalles del pedido.",
    },
    {
      q: "¿Pago seguro?",
      a: "Pago online con proveedores establecidos. Confirmación tras pago exitoso.",
    },
    {
