  ...
  return (
    <div className="space-y-6 text-start">
      ...
      <div className="rounded-2xl border-2 border-teal-300 bg-white p-6 shadow-lg">
        <h2 className="mb-2 text-lg font-semibold text-[#0d2137]">{t("reports.invoicesTitle")}</h2>
        <p className="mb-4 text-sm text-[#0d2137]/70">{t("reports.invoicesDesc")}</p>
        {paidList.length === 0 ? (
          <p className="text-sm text-[#0d2137]/60">{t("reports.noPaid")}</p>
        ) : (
          <div className="overflow-x-auto rounded-xl border border-[#0d2137]/15">
            <table className="w-full min-w-[640px] border-collapse text-sm">
              <thead>
                <tr className="border-b-2 border-[#0d2137]/15 bg-[#0d2137]/[0.04] text-start">
                  <th className="px-3 py-2.5 font-semibold text-[#0d2137]">{t("reports.colNr")}</th>
                  <th className="px-3 py-2.5 font-semibold text-[#0d2137]">{t("common.company")}</th>
                  <th className="px-3 py-2.5 font-semibold text-[#0d2137]">{t("common.date")}</th>
                  <th className="px-3 py-2.5 font-semibold text-[#0d2137]">{t("reports.colAmount")}</th>
