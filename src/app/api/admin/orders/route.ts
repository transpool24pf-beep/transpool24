...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from("jobs")
    .select("id, order_number, company_name, phone, customer_email, pickup_address, delivery_address, cargo_size, distance_km, price_cents, driver_price_cents, payment_status, logistics_status, created_at, preferred_pickup_at, confirmation_token")
