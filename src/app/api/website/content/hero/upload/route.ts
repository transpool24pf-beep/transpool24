...
export async function POST(req: Request) {
  ...
  try {
    ...
    const filename = typeof body.filename === "string" ? body.filename : "hero.jpg";
    ...
    const path = `homepage-hero/${randomUUID()}-${safe}.${ext}`;
    ...
    if (upErr) {
      console.error("[website/hero/upload]", upErr);
    ...
    console.error("[website/hero/upload]", e);
