...
export async function POST(req: Request) {
  ...
  try {
    ...
    const filename = typeof body.filename === "string" ? body.filename : "tile.jpg";
    ...
    const path = `homepage-transport/${randomUUID()}-${safe}.${ext}`;
    ...
    if (upErr) {
      console.error("[website/transport-tiles/upload]", upErr);
    ...
    console.error("[website/transport-tiles/upload]", e);
