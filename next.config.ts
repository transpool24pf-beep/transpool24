...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    return [
      ...
      {
        source: "/(favicon.ico|favicon-32.png|favicon-48.png|icon.png|email-header.png|transpool24-email-banner.png|transpool24-email-logo.png|invoice-logo.png|5439.png)",
        headers: [
